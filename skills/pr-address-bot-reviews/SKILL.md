...
- Reply in the correct channel:
  - Inline review thread: use `gh api .../pulls/<pr>/comments -F in_reply_to=<comment_id>`
...
gh api repos/<owner>/<repo>/pulls/<number>/comments -f body="<response>" -F in_reply_to=<comment_id>
